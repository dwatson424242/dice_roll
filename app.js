		...
		{type: 'list', name: 'action', message: "\n --- Choose an Option --- \n", choices:['Generate Random Numbers', 'Roll Dice', 'Roll By Position', 'Exit']},
			...
			switch(answer.action) {
				case 'Generate Random Numbers':
					global.rolls = chain_dice_rolls(20, secret);
					console.log(rolls);
					global.runcli();
				break;
				case 'Roll Dice':
					[roll, rolls] = get_next_dice_roll(global.rolls, secret);
					console.log(roll);
					global.runcli();
				break;
				case 'Roll By Position':
					...
					inquirer.prompt({
					    type: 'input',
					    name: 'position',
					    message: "Enter your position from 1..20: ",
						validate: function (value) {
					  	...
					  	[roll, rolls] = get_dice_roll_by_position(answer2.position, global.rolls, secret);
					  	console.log(roll);
						global.runcli();
					  });
